...
for encuestas in range(1,24):
	print '{0:d} {1:d}'.format(23,encuestas) #agentes y #encuestas
	for unaencuesta in range(0,encuestas):
		print '{0:d} {1:s}{2:d}'.format(random.randint(1, 23), random.choice(' -'), random.randint(1, 23))
