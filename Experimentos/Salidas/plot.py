...
#salidaRandomP = bloques(datos("SalidaPodasRandom"), 100)
salidaVariacion = bloques(datos("Variaciones"), 100)
#salidaVariacionPositiva = bloques(datos("VariacionesPositivas"), 100)
#salidaVariacion = bloques(datos("VariacionesPodas"), 100)
#salidaVariacionPositiva = bloques(datos("VariacionesPodasPositivas"), 100)
#salidaFuncion = bloques(datos("FuncionListo"), 1)
#salidaPositivasP = bloques(datos("SalidaPodasPositiva"), 100)
#salidaNegativaP = bloques(datos("SalidaPodasNegativa"), 100)
...
#plt.plot(nada+salidaVariacionPositiva)
#plt.plot(nada+salidaVariacionPositiva)
...
#plt.plot(nada+salidaNegativa)
plt.legend( ['Instancia Random'], loc = 'upper left', fontsize = 15)
#plt.legend(["Caso Random"])
plt.grid(True)
plt.grid(color = '0.5', linestyle = '--', linewidth = 1)
#plt.axis('tight')
#plt.axis([0, 20, 0, 5])
plt.xlabel(r"Cantidad de Encuestas", fontsize = 24, color = 'black')
plt.ylabel(r"Tiempo en Segundos", fontsize = 24, color = 'black')
plt.title('Variacion de encuentas (sin podas)',fontsize = 28, color = 'black', verticalalignment = 'baseline', horizontalalignment = 'center')
plt.show()