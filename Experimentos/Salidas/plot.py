...
salidaVariacion = bloques(datos("SalidaVariacion"), 1)
#salidaRandomP = bloques(datos("SalidaPositivaPodas"), 100)
...
#plt.plot(nada+salidaNegativa)
plt.legend( ['salida Variacion'], loc = 'upper left', fontsize = 15)
#plt.legend(["Caso Random"])
plt.grid(True)
...
plt.title('Variacion',fontsize = 28, color = 'black', verticalalignment = 'baseline', horizontalalignment = 'center')
plt.show()